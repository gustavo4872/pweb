...
import br.unisul.web.sexta.services.EventoService;
...
public class EventoResource {
	...
	public ResponseEntity<List<EventoDTO>> find(@RequestParam(value = "nome", defaultValue = "") String nome) {
		String nomeDecoded = URL.decodeParam(nome);
		List<Evento> list = service.search(nomeDecoded);
		List<EventoDTO> listDto = new ArrayList<EventoDTO>();
		for (Evento e : list) {
			listDto.add(new EventoDTO(e));
		}
